...
void main() {
  ...
  test(
    'Manual approval PayPal flow with refund, capture & transactions',
    () async {
      ...
      for (int i = 0; i < 5; i++) {
        ...
        final relatedResources =
            refreshedPayment['transactions'][0]['related_resources'];
        if (relatedResources.isNotEmpty &&
            relatedResources[0]['authorization'] != null) {
      ...
      if (authorization == null) {
        fail(
          'Authorization not returned by PayPal sandbox after retries. Cannot capture.',
        );
      }
